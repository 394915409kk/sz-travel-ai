...
- 仓库：`394915409kk/sz-travel-ai`（main = codex 搭建的系统代码，勿混用；WorkBuddy 交付物统一放 `workbuddy/` 目录）
...
- GitHub 推送：mcp__github__push_files（分支 workbuddy/ops-baseline，目录 workbuddy/）
